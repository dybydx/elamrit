/**
 * Site-root paths for split PageHero / ChildServiceHero background images (`/images/...`).
 * Used with `heroImageSrc`; CSS falls back to `defaultHero` when omitted.
 */
...
export const menuInternational = '/images/menus/menu-card-international.png';
export const menuFusion = '/images/menus/menu-card-fusion.png';
export const menuDesserts = '/images/menus/menu-card-desserts.png';
export const menuBeverages = '/images/menus/menu-card-beverages.png';

export const weddingHindu = '/images/services/wedding-gallery-1.png';
export const weddingPreEvent = '/images/services/wedding-gallery-2.png';
export const weddingDestination = '/images/services/wedding-gallery-3.png';
export const weddingMulticultural = '/images/services/wedding-gallery-1.png';

export const corporateGala = '/images/services/corporate-gallery-3.png';
export const corporateBusiness = '/images/services/corporate-gallery-1.png';
export const corporateLaunch = '/images/services/corporate-gallery-2.png';
export const corporateEvents = '/images/services/corporate-gallery-1.png';

export const socialBirthday = '/images/services/social-gallery-1.png';
export const socialCocktail = '/images/services/social-gallery-2.png';
export const socialAnniversary = '/images/services/social-gallery-3.png';
export const socialHouseWarming = '/images/services/social-gallery-1.png';
